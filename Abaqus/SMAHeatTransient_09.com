...
options = {
    ...
    'input':'SMAHeatTransient_09_template',
    'inputFormat':INP,
    'inputSize':172169,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'jleJobExcluded':True,
    'job':'SMAHeatTransient_09',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'listener_name':'AERO-MJ0JAKC7.engr.tamu.edu',
    'listener_resource':'548',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'simpackBodies':[],
    'soils':OFF,
    'solverTypes':['DIRECT', 'DIRECT', 'DIRECT', 'DIRECT', 'DIRECT', 'DIRECT', 'DIRECT', 'DIRECT', 'DIRECT'],
    'sradiate':ON,
    'ssd':OFF,
    'ssdCheckOK':False,
    'ssdDirect':OFF,
