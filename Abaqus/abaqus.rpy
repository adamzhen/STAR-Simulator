...
# Run by adzheng on Wed Jul  8 15:41:35 2026
#
...
execfile('H:/STAR-Simulator/Abaqus/scripts/starsim.py', __main__.__dict__)
#: 
#: ################
#: RUN NO: 0.7
#: Date: 2026-07-08
...
#: FreeCAD macro finished in 15.4 s
...
#: Meshing the strip
#: Loaded 1511 flux points from H:/STAR-Simulator/Scenarios/SMAScenario1/flux_data.csv
...
#: from analytical field "Flux_Field_1": 
...
#: Iteration 1 elapsed time: 43.681 seconds
#: 
#: ========================================
...
#: from analytical field "Flux_Field_2": 
#: The mapper has mapped the field values using distance weighting 
#: algorithm for some of the target nodes.
...
#: Iteration 2 elapsed time: 40.708 seconds
#: 
#: DONE with all iterations.
#: Total iterative analysis time: 84.397 seconds
...
#: HFL colorscale: 0 to 364.0 (95th pct)
#: Saved: H:/STAR-Simulator/Scenarios/SMAScenario1/run_documentation/iterative_analysis_0.7\mapped_hfl_on_mesh_0.7.png
#: Iter 1: dU=(-0.0135, 0.0000, -0.1447) m  cum|U|=0.1453 m  node=1111  T=[4.4, 4.4] K
#: Iter 2: dU=(-0.0307, 0.0000, -0.1156) m  cum|U|=0.2640 m  node=11  T=[4.5, 4.7] K
#: Saved cumulative tip displacement to H:/STAR-Simulator/Scenarios/SMAScenario1/run_documentation/iterative_analysis_0.7\tip_displacements_0.7.csv
#: 
#: DONE with all analyses.
#: Total script elapsed time: 86.234 seconds
